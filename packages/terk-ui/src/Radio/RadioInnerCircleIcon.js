...
import { StyledRadioInnerFilledCircelIcon } from "./styles";

const RadioInnerFilledCircleIcon = () => (
  <StyledRadioInnerFilledCircelIcon>
...
export default RadioInnerFilledCircleIcon;
